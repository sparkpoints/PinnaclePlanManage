...
A pinnacle file is similar in structure to a json file although not identical.

Script parses thepinnacle file and resolves the syntax differences to make a valid json specification conforming string which contains all the data present in the original file.

"""
# ----------------------------------------- #


class pinnacle3tps2json(object):
    def __init__(self):
        return
