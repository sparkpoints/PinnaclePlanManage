...
class scan_standard_pinn_DB(object):
    ...
    def print_whole_patients_in_DB(self):
        for list in self.inst_list:
            ...
            # print("\n")
            for patient in obj2.get_patient_list_in_inst(list):
                print(patient)
                # print("\n")
    ...
    def create_patient_list_record(self):
        ...
        for list in self.inst_list:
            ...
            for patient in obj2.get_patient_list_in_inst(list):
                current_pat_path = os.path.join(
                    self.root_path, list, 'Mount_0', patient)
...
class tar_one_pinn_patient(object):
    def __init__(self, working_dir, target_dir):
        ...
        patient_obj = parse_single_pinn_file(
            os.path.join(self.data_dir, 'Patient'))
    ...
    def get_inst_header_template(self, patient_info):
        template_pool = '/home/peter/document/'
    ...
    def creat_tar_file(self):
        ...
        #command = TAR + ' -cvf ' + tarName + ' Insititution '  + ' --add-file=' + refpath
        #command = TAR + ' -cvf ' + tarName + ' Institution '
        # os.system(command)
        subprocess.call([TAR, '-cvf', tarName, inst_header])
        subprocess.call([TAR, '-rvf ', tarName, refpath])
...
if __name__ == "__main__":
    ...
    patientfile = "/home/peter/Institution_2938/Mount_0/Patient_30942"
    obj3 = tar_one_pinn_patient('/home/peter', patientfile)
    obj3.creat_tar_file()

    root_path = "/media/PinnSETemp/BetaPatients/"
    record_file = "/home/peter/document/testlog"
    obj2 = scan_standard_pinn_DB(root_path, record_file)
    obj2.get_inistitution_list()
